...
$(document).ready(function() {
	$(".baby_message_span").on("mousedown", function(event) {
...
function removeRipple() {
	...
	if ($(".ripple").is(".rippleExpandEffect") || $(".ripple").is(".rippleShrinkEffect")) {
		...
		$(".ripple").css({
			"-webkit-transform": "scale(" + animation_scale +")",
			"-moz-transform": "scale(" + animation_scale +")",
			"-o-transform": "scale(" + animation_scale +")",
			"-ms-transform": "scale(" + animation_scale +")",
...
$(document).ready(function() {
	$(".baby_message_span").on("mouseup", function() {
		removeRipple();
		$(this).blur();
	});
});
...
$(document).ready(function() {
	$(".baby_message_span").on("mouseleave", function() {
		removeRipple();
		$(this).blur();
	});
});
